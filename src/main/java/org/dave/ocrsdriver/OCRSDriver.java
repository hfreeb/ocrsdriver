...
@Mod(modid = OCRSDriver.MODID, version = OCRSDriver.VERSION, dependencies = "required-after:OpenComputers;required-after:refinedstorage", acceptableRemoteVersions = "*")
